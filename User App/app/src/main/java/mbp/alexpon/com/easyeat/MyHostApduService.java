...
//////////////////////////////////////////////////////// PERSO /////////////////////////////////////////////////////
            ...
            switch (apdu[2]){
                ...
                case 0x06:
                    ...
                    break;
                case 0x07:
                    digitalSignature = Arrays.copyOfRange(apdu, 5, 37);
                    break;
                case 0x08:
                    pinCode = Arrays.copyOfRange(apdu, 5, 13);
                    break;
                case 0x09:
                    money = byteArrayToInt(Arrays.copyOfRange(apdu, 5, 15));
                    break;
                default:
...
////////////////////////////////////////////////// WRITE NORMAL DATA ///////////////////////////////////////////////
            ...
            if (pinVerified) {
                ...
                if (apdu[3] == 0x00) {              ///// ADD MONEY
                    byte[] add_money = Arrays.copyOfRange(apdu, 5, 15);
                    money += byteArrayToInt(add_money);
                } else if (apdu[3] == 0x01) {         ///// PAY
                    byte[] sub_money = Arrays.copyOfRange(apdu, 5, 15);
                ...
                } else if (apdu[3] == 0x03) {          ///// EXPIRED DATE
                    certiExpiredDate = Arrays.copyOfRange(apdu, 5, 11);
                } else {                              ///// Undefined
                    answer = new byte[2];
                    answer[0] = (byte) 0x04;
